  ...
  return (
    <>
      <header className="header">
        <div data-animation="default" className="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="medium"
          data-no-scroll="1" data-duration="0" data-doc-height="1">
          <h1 style={{ padding: " .8rem 0" }} >DevCoders</h1>
        </div>
      </header>
